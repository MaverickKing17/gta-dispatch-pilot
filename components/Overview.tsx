      ...
      <section id="overview" className="py-40 bg-slate-50 relative overflow-hidden">
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mb-24">
            <h2 className="text-7xl font-black text-navy mb-10 tracking-tighter">Pilot Overview</h2>
            <p className="text-3xl text-slate-800 font-extrabold leading-relaxed">
          ...
          <div className="grid lg:grid-cols-3 gap-16">
            <div className="bg-white p-14 rounded-[3rem] shadow-[0_30px_60px_-10px_rgba(0,0,0,0.1)] border-2 border-slate-100 hover:border-orange-500 transition-all group hover:-translate-y-2">
              ...
              <p className="text-xl text-slate-700 font-bold leading-relaxed">Built-in protocols for TSSA compliance and gas leak triage, ensuring immediate redirection to emergency services.</p>
            </div>
            <div className="bg-white p-14 rounded-[3rem] shadow-[0_30px_60px_-10px_rgba(0,0,0,0.1)] border-2 border-slate-100 hover:border-orange-500 transition-all group hover:-translate-y-2">
              ...
              <p className="text-xl text-slate-700 font-bold leading-relaxed">Every repair call is screened for rebate potential. We identify candidates for $7,500 heat pump replacements automatically.</p>
            </div>
            <div className="bg-white p-14 rounded-[3rem] shadow-[0_30px_60px_-10px_rgba(0,0,0,0.1)] border-2 border-slate-100 hover:border-orange-500 transition-all group hover:-translate-y-2">
              ...
              <p className="text-xl text-slate-700 font-bold leading-relaxed">Chloe handles the soft-sell and service, while Sam takes over for high-stakes emergency situations.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col xl:flex-row gap-24 items-center">
            <div className="xl:w-1/2">
              <h2 className="text-7xl font-black text-navy mb-12 tracking-tighter">Dual-Logic Showcase</h2>
              <div className="space-y-16">
                <div className="flex gap-10 group">
                  ...
                  <div>
                    ...
                    <p className="text-2xl text-slate-700 font-bold leading-relaxed">The "Red Tag" logic ensures that any gas leak or carbon monoxide mention triggers an immediate safety broadcast and a 911 handoff.</p>
                  </div>
                </div>
                <div className="flex gap-10 group">
                  ...
                  <div>
                    ...
                    <p className="text-2xl text-slate-700 font-bold leading-relaxed">Capture Ontario government funding for your customers. Our AI calculates eligibility for the Home Renovation Savings program in real-time.</p>
                  </div>
                </div>
              </div>
            </div>
